...
/**
 * @Title:BaseFragmentationActivity
 * @Package:com.repertory.xingyao.view.base
 * @Description:MVP 架构中的 V 层 aty(fragmentation)基类抽象层;整合替换fragmentation的SupportActivity类
 * @Auther:YJH
 * @Email:yuannunhua@gmail.com
 * @Date:2018/10/1816:45
 */
public abstract class BaseFragmentationActivity<T extends IBasePresenter> extends RxAppCompatActivity implements ISupportActivity,IBaseView {
    ...
    public void loadRootFragment(int containerId, @NonNull ISupportFragment toFragment) {
        Logger.e("loadRootFragment--->"+containerId);
        Logger.e("loadRootFragment--->"+toFragment);
