...
/**
 * @Title:BaseFragmentationFragment
 * @Package:com.repertory.xingyao.view.base
 * @Description:架构中的 V 层 fragment(fragmentation)基类抽象层;整合替换fragmentation的SupportFragment类
 * @Auther:YJH
 * @Email:yuannunhua@gmail.com
 * @Date:2018/10/1817:27
 */
public abstract class BaseFragmentationFragment <T extends IBasePresenter> extends RxFragment implements ISupportFragment,IBaseView {
